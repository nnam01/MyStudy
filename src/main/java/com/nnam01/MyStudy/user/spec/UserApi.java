...
public interface UserApi {
  ...
  ResponseEntity<Void> createUser(@RequestBody(required = true) UserRequestDto requestDto);
  ...
  @GetMapping("/me")
  public ResponseEntity<UserDto> getMyInfo(@RequestAttribute("userId") Long userId);
}
